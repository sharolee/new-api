...
func InitOptionMap() {
	...
	common.OptionMap["FallbackModelRatio"] = strconv.FormatFloat(ratio_setting.GetFallbackModelRatio(), 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "FallbackModelRatio":
		if floatValue, convErr := strconv.ParseFloat(value, 64); convErr == nil {
			ratio_setting.SetFallbackModelRatio(floatValue)
		}
	case "TopUpLink":
