...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		dataRoute.GET("/error", middleware.AdminAuth(), controller.GetAllErrorLogStats)
		dataRoute.GET("/error/self", middleware.UserAuth(), controller.GetUserErrorLogStats)
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/available", controller.GetAvailableModelsMeta)
			modelsRoute.GET("/available/channels", controller.GetAvailableChannelsMeta)
			modelsRoute.GET("/available/:model", controller.GetAvailableModelMeta)
			modelsRoute.GET("/categories", controller.GetAllModelCategories)
			modelsRoute.GET("/categories/:id", controller.GetModelCategory)
			modelsRoute.POST("/categories", controller.CreateModelCategory)
			modelsRoute.PUT("/categories/:id", controller.UpdateModelCategory)
			modelsRoute.DELETE("/categories/:id", controller.DeleteModelCategory)
			modelsRoute.POST("/available/:model/categories", controller.AssignModelCategories)
			modelsRoute.GET("/available/:model/categories", controller.GetModelCategoriesByModel)
			modelsRoute.GET("/categories/:id/models", controller.GetModelCategoryNames)
